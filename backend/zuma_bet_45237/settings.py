"""
Django settings for zuma_bet_45237 project.
...
ROOT_URLCONF = 'zuma_bet_45237.urls'
...
WSGI_APPLICATION = 'zuma_bet_45237.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "zuma_bet_45237 API",
    "DESCRIPTION": "API documentation for zuma_bet_45237 App",
    "VERSION": "v1",
}
